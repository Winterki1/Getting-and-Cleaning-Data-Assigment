...
For each of the following measurements, the data set shows the average by subject and activity. Note that the measurements were normalized and bounded within [-1,1]. 
